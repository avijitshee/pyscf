...
def kernel_lanczos(fci, h1e_drive, extra_arg_drive, grid_drive, eri, norb, nelec, ci0=None, link_index=None,
               tol=None, lindep=None, max_cycle=None, max_space=None,
               nroots=None, davidson_only=None, pspace_size=None,
    ...
    h1e = h1e_drive(0.0, extra_arg_drive[0], 0.0, extra_arg_drive[2], extra_arg_drive[3])
...
#           ci0 = lambda: fci.get_init_guess(norb, nelec, nroots, hdiag)
    ...
    densa, densb = make_rdm1s(c, norb, nelec, link_index)

    den0 = densa + densb

#   h1e = h1e_drive(0.0, extra_arg_drive[0], extra_arg_drive[1], extra_arg_drive[2], extra_arg_drive[3])
#    h1e = h1e_drive(0.0, extra_arg_drive[0], 0.00, extra_arg_drive[2], extra_arg_drive[3])
#    h2e = fci.absorb_h1e(h1e, eri, norb, nelec, .5)
...
# we may need to repeat the Lanczos steps. Therefore it is better to write a function that includes all the opeartions below:
    ...
    with lib.with_omp_threads(fci.threads):
        A, alpha, beta = lib.lanczos_tridiagonalize(aop=hop, x0=c, tol=tol, lindep=lindep,
...
#           d[0] = 1.0 + 1j*0.0  
           ...
           h1e = h1e_drive(grid[count-1], extra_arg_drive[0], extra_arg_drive[1], extra_arg_drive[2], extra_arg_drive[3])
           h2e = fci.absorb_h1e(h1e, eri, norb, nelec, .5)
           ...
           print("lanczos dimension", len_tdiag)
...
class FCIBase(lib.StreamObject):
    ...
    def kernel(self, h1e_drive, extra_arg_drive, grid_drive, eri, norb, nelec, ci0=None,
               tol=None, lindep=None, max_cycle=None, max_space=None,
               nroots=None, davidson_only=None, pspace_size=None,
